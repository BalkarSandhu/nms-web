...
export default function WorkersReportsPage() {
        ...
        <body>
          ...
          <div class="page">
            ...
            <div class="summary-section">
              ...
              <div class="summary-box">
                <p>This report contains detailed information about workers. Total Records: ${reportData?.workers?.length || 0}</p>
              </div>
            </div>

            <div class="footer">
              <p>This report is auto-generated by Report System</p>
          ...
          <div class="page">
            ...
            <div class="footer" style="margin-top: 32px;">
              <p>End of Report - Total Records: ${reportData?.workers?.length || 0}</p>
              <p style="margin-top: 4px;">© ${new Date().getFullYear()} Report System. All rights reserved.</p>
            </div>
          </div>
        </body>
      </html>
  ...
  return (
    <div className="p-4">
      <div className="p-4">
        <label htmlFor="" className="block mb-4 text-lg font-semibold">Workers Report</label>
      ...
      {reportData && (
        <div className="p-2">
          ...
          <div className="mb-6 flex gap-3">
            <button
              onClick={handlePrint}
              className="px-2 py-2 bg-(--azul)/80 text-white rounded-lg flex items-center gap-1 hover:bg-(--azul)/90 text-sm"
            >
              <Printer size={12} />
              Print Report
            </button>
            ...
            <button
              ...
              className="px-1 py-2 bg-green-600 text-white rounded-lg flex items-center gap-1 hover:bg-green-700 text-sm"
            >
              <Download size={12} />
              Download Pdf
            </button>
          ...
          {lastFilters && (
            <div className="mt-4 text-sm text-gray-700">
              <strong>Generated with filters:</strong>
            </div>
          )}
        </div>
      )}
