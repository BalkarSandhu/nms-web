...
export default function LocationsReportsPage() {
  ...
  const generateTableHTML = (filters: any) => {
    const config = getReportConfig('locations');
        ...
        <body>
          ...
          <div class="page">
            ...
            <div class="footer" style="margin-top: 32px;">
              <p>End of Report - Total Records: ${reportData?.locations?.length || 0}</p>
  ...
  return (
    <div className="p-4">
      <div className="p-4">
        <label htmlFor="" className="block mb-4 text-lg font-semibold">Locations Report</label>
