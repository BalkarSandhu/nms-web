...
export default function Metric1({ 
    ...
    return (
        <BaseCard title={title} menuGroups={resolvedMenuGroups} className={className}>
            {viewMode === 'stats' ? (
                <div className="flex items-center gap-4 min-h-[140px] py-2">
                ...
                Total
                    ...
                    <div className="flex flex-col gap-1.5 flex-1 pb-2">
                        ...
                        <button
                            ...
                            className="flex items-center justify-between px-2 py-1 rounded-md hover:bg-(--contrast)/5 transition-colors group"
                        >
