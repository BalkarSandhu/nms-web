    ...
    <div className="flex min-h-screen w-full overflow-hidden bg-(--dark)">
      ...
      {useLayout ? (
          ...
          <SidebarProvider defaultOpen className="flex-1 overflow-hidden">
            ...
            <SidebarInset className="p-0 m-0 flex-1 min-w-0 overflow-hidden">
              <div className="flex h-full w-full flex-col overflow-hidden">
                <header className="flex fixed top-0 left-0 right-0 z-50 bg-(--dark) h-12 shrink-0 items-center gap-2 border-none \
        ...
        rounded-t-5 w-full">
              ...
              <div className="flex-1 min-w-0 overflow-x-auto mt-12">
                <Routes>
