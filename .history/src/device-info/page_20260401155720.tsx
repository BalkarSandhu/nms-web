    ...
    <div className="min-h-screen bg-gray-900 p-6">
      ...
      <div className="mb-8 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <div className={`px-3 py-1 rounded-full font-medium text-sm flex items-center gap-2 ${
            hasPower ? 'bg-green-900 text-green-300' : 'bg-red-900 text-red-300'
          }`}>
          ...
          <div className={`px-3 py-1 rounded-full font-medium text-sm flex items-center gap-2 ${
            isDeviceOnline ? 'bg-green-900 text-green-300' : 'bg-red-900 text-red-300'
          }`}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="space-y-6">
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 gap-3">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-sm font-semibold text-white">{device.display || device.hostname}</span>
                </div>
                ...
                <div className="flex justify-between items-center">
                  <span className="text-sm font-medium text-gray-400">Device Type</span>
                  <span className="text-sm font-semibold text-white">{device.device_type?.name || 'Unknown'}</span>
                </div>

                <div className="flex justify-between items-center">
                  <span className="text-sm font-medium text-gray-400">Location</span>
                  <span className="text-sm font-semibold text-white">{device.location?.name || 'Unknown'}</span>
                </div>

                <div className="flex justify-between items-center">
                  <span className="text-sm font-medium text-gray-400">Area</span>
                  <span className="text-sm font-semibold text-white">{device.worker?.name || 'N/A'}</span>
                </div>

                <div className="flex justify-between items-center">
                  <span className="text-sm font-medium text-gray-400">Coordinates</span>
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-sm font-semibold text-white">{formatTimeAgo(device.created_at)}</span>
                </div>

                <div className="flex justify-between items-center">
                  <span className="text-sm font-medium text-gray-400">Last Updated</span>
                  <span className="text-sm font-semibold text-white">{formatTimeAgo(device.updated_at)}</span>
                </div>

                <div className="flex justify-between items-center">
                  <span className="text-sm font-medium text-gray-400">Last Seen</span>
                  <span className="text-sm font-semibold text-white">{formatTimeAgo(device.last_check)}</span>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          {/* Logs Card */}
          <Card className="border border-gray-700 shadow-sm hover:shadow-md transition bg-gray-800">
            <CardHeader>
              <CardTitle className="flex items-center gap-1 text-m font-semibold text-white">
        ...
        <div className="lg:col-span-2 space-y-2">
          ...
          {/* Map Card */}
          <Card className="border border-gray-700 shadow-sm hover:shadow-md transition overflow-hidden h-126 bg-gray-800">
            <CardHeader>
              <CardTitle className="flex items-center gap-1 text-m font-semibold text-white">
