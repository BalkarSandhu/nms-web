...
import { ArrowLeft, MapPin, Activity, Server, FileText, Signal, AlertCircle, CheckCircle2, Wifi, WifiOff, Power, Zap, Monitor, Network } from 'lucide-react';
            ...
            <CardContent className="p-2">
              <div className="space-y-0">
                ...
                <div className="space-y-2">
                  <div className="text-sm text-gray-600 flex justify-between">
                    <span>Last Ping:</span>
                    <span className='font-medium'>{formatTimeAgo(device.last_ping)}</span>
                  </div>
                </div>
                ...
                <div className="flex flex-col items-center justify-center py-4">
                  {hasPower ? (
                    <div className="flex flex-col items-center">
                      <Power className="w-16 h-16 text-green-600 animate-pulse drop-shadow-md mb-3" />
