...
export default function DeviceDetailPage() {
  ...
  if (!device) {
    return (
      <div className="p-2 text-center bg-gray-900 min-h-screen">
        <p className="text-m text-gray-400">Device not found</p>
              ...
              <CardContent className="p-3">
                <div className="flex flex-wrap items-center gap-2 mb-3">
                  ...
                  <div className="ml-auto flex items-center gap-2">
                    ...
                    <select
                      className="border border-gray-600 rounded px-2 py-1 text-xs bg-gray-700 text-white"
                      value={granularity}
                ...
                {historyLoading ? (
                  ...
                  <div className="h-64 flex items-center justify-center text-gray-400">No history data for selected range</div>
                ) : (
                  <div className="h-64">
