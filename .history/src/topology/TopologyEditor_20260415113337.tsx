...
const TopologyEditor = () => {
  ...
  const { locations, loading: locationsLoading, error: locationsError } = useSelector((state: any) => state.locations);

  // Function to build hierarchical tree from flat locations
  const buildTree = useCallback((flatLocations: Location[]): Location[] => {
    ...
    flatLocations.forEach(loc => {
      if (loc.parent_id) {
        ...
        if (parent) {
          parent.children!.push(map.get(loc.id)!);
        }
      } else {
  ...
  // Process locations into tree data
  ...
  const fetchTopology = useCallback(async () => {
    try {
      setError(null);
      await dispatch(fetchAllLocationsPaginated()).unwrap();
    } catch (err) {
      setError((err as Error).message);
        ...
        {
          id: 36,
          name: 'CCWO COMMUNITY CENTER',
          parent_id: null,
          latitude: 23.815638,
          longitude: 86.460988,
          status: 'partial',
          status_reason: '1 of 2 device(s) online',
          location_type_id: 34,
          area: 'CCWO',
          worker_id: 'WIN-091V5OCIN25-208810d44cd0',
          device_count: 2,
          ...
          children: [
            {
              id: 32,
              name: 'CCWO CONTROL ROOM',
              parent_id: 36,
              latitude: 23.815244,
              longitude: 86.460602,
              status: 'online',
              status_reason: 'All 4 device(s) online',
              location_type_id: 20,
              area: 'CCWO',
              worker_id: 'WIN-091V5OCIN25-208810d44cd0',
              device_count: 4,
              ...
              children: [
                {
                  id: 38,
                  name: 'CCWO POWER SUBSTATION',
                  parent_id: 32,
                  latitude: 23.815087,
                  longitude: 86.461138,
                  status: 'online',
                  status_reason: 'All 2 device(s) online',
                  location_type_id: 5,
                  project: 'CCWO',
                  area: 'CCWO',
                  worker_id: 'WIN-091V5OCIN25-208810d44cd0',
                  ...
                  has_children: false,
                  depth: 2,
                  created_at: '2026-01-05T17:11:11.843388+05:00',
                  updated_at: '2026-04-10T14:08:45.594299+05:00',
                  children: [],
                },
              ],
              created_at: '2026-01-05T17:11:08.711903+05:00',
              updated_at: '2026-04-10T14:08:45.62061+05:00',
            },
          ],
          created_at: '2026-01-05T17:11:10.904663+05:00',
          updated_at: '2026-04-10T14:08:45.615816+05:00',
        },
        {
          id: 51,
          name: 'CCWO GUEST HOUSE',
          parent_id: null,
          latitude: 23.81635,
          longitude: 86.46088,
          status: 'offline',
          status_reason: 'All 1 device(s) offline',
          location_type_id: 10,
          area: 'CCWO',
          worker_id: 'WIN-091V5OCIN25-208810d44cd0',
          device_count: 1,
          ...
          has_children: false,
          depth: 0,
          created_at: '2026-01-05T17:11:17.763741+05:00',
          updated_at: '2026-03-25T10:21:18.838859+05:00',
          children: [],
        },
  }, [dispatch]);

  // Process tree data when locations change
  useEffect(() => {
  ...
  }, [treeData, selectedArea, setNodes, setEdges]);
  ...
  return (
    ...
    >
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            ...
            <button
              ...
              style={{
                ...
                opacity: locationsLoading ? 0.5 : 1,
                transition: 'all 0.2s',
              }}
            >
              <RefreshCw
                size={16}
                style={{ animation: locationsLoading ? 'spin 1s linear infinite' : 'none' }}
              />
            </button>
      ...
      <div style={{ flex: 1, position: 'relative', overflow: 'hidden' }}>
        ...
        {/* Empty state */}
        {!locationsLoading && !(error || locationsError) && nodes.length === 0 && (
          <div
            style={{
              display: 'flex',
              flexDirection: 'column',
