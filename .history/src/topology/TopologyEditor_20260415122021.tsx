...
import { fetchAllLocationsPaginated, fetchLocationsforMap } from '@/store/locationsSlice';
      ...
      >
        ...
        >
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            ...
            {/* Refresh */}
            {/* <button
              onClick={() => dispatch(fetchAllLocationsPaginated())}
              disabled={loading}
              title="Refresh"
              style={{
                padding: 8,
            ...
            <button
              onClick={() => dispatch(fetchLocationsforMap())}
              disabled={loading}
              title="Refresh"
              style={{
                padding: 8,
