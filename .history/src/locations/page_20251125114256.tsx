...
//--Local components
import LocationsFilters, { type FilterConfig } from './local-components/filters';
import LocationModifier from './local-components/location-modifier';
...
export default function LocationsTable({ 
    ...
    const handleRowClick = (locationId: number) => {
        console.log('Row clicked, location ID:', locationId); // Debug log
