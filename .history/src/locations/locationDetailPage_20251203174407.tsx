          ...
          <Card className="border border-gray-200 shadow-sm hover:shadow-md transition">
            ...
            <CardContent className="p-2">
              <div className="space-y-0">
                ...
                <div className="space-y-1">
                  <div className="text-sm text-gray-600">Created : {formatTimeAgo(location.created_at)}</div>
                </div>

                <div className="border-t border-gray-200"></div>

                <div className="space-y-1">
                  <div className="text-sm text-gray-600">Last Updated: {formatTimeAgo(location.updated_at)}</div>
