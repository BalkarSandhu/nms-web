      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="space-y-4">
          ...
          <Card className="border border-gray-200 shadow-sm hover:shadow-md transition">
            <CardHeader className="bg-gradient-to-r from-blue-50 to-blue-50 border-b border-gray-200 p-4">
          ...
          {/* Devices Card */}
          <Card className="border border-gray-200 shadow-sm hover:shadow-md transition">
            <CardHeader className="bg-gradient-to-r from-purple-50 to-purple-50 border-b border-gray-200 p-4">
              <CardTitle className="flex items-center gap-3 text-lg font-semibold text-gray-900">
          ...
          {/* Logs Card */}
          <Card className="border border-gray-200 shadow-sm hover:shadow-md transition">
            <CardHeader className="bg-gradient-to-r from-amber-50 to-amber-50 border-b border-gray-200 p-4">
              <CardTitle className="flex items-center gap-3 text-lg font-semibold text-gray-900">
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <Card className="border border-gray-200 shadow-sm hover:shadow-md transition">
              <CardHeader className="bg-gradient-to-r from-green-50 to-green-50 border-b border-gray-200 py-3 px-4">
            ...
            <Card className="border border-gray-200 shadow-sm hover:shadow-md transition">
              <CardHeader className="bg-gradient-to-r from-orange-50 to-orange-50 border-b border-gray-200 py-3 px-4">
