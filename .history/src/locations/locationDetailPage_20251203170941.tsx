    ...
    <div className="min-h-screen bg-white p-6">
      ...
      <div className="mb-8">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            <div className={`p-3 rounded-lg ${isLocationOnline ? 'bg-emerald-100' : 'bg-red-100'}`}>
              <Network className={`h-8 w-8 ${isLocationOnline ? 'text-emerald-600' : 'text-red-600'}`} />
            </div>
            <div>
              <h1 className="text-3xl font-bold text-gray-900">{location.name}</h1>
              <p className="text-gray-500 text-sm mt-1">Network Location</p>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          ...
          {/* Logs Card */}
          <Card className="border border-gray-200 shadow-sm hover:shadow-md transition">
            <CardHeader className="bg-gradient-to-r from-amber-50 to-amber-50 border-b border-gray-200">
              <CardTitle className="flex items-center gap-3 text-lg font-semibold text-gray-900">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="grid grid-cols-2 gap-6">
            <Card className="border border-gray-200 shadow-sm hover:shadow-md transition">
              <CardHeader className="bg-gradient-to-r from-green-50 to-green-50 border-b border-gray-200">
            ...
            <Card className="border border-gray-200 shadow-sm hover:shadow-md transition">
              <CardHeader className="bg-gradient-to-r from-orange-50 to-orange-50 border-b border-gray-200">
                <CardTitle className="text-lg font-semibold text-gray-900">Network Health</CardTitle>
              </CardHeader>
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-center h-32">
                  <div className="text-center">
                    ...
                    <p className="text-gray-500 text-sm mt-2">Signal Quality</p>
                  </div>
                </div>
              </CardContent>
            </Card>
