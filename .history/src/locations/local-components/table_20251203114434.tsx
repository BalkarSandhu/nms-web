                ...
                <Table className="table-fixed w-full">
                    <TableHeader className="bg-gray-50 sticky top-0 z-10">
                        <TableRow className="border-b-2 border-gray-200">
                            ...
                            <TableHead className="w-[31%] font-semibold text-gray-700">Location Name</TableHead>
                            <TableHead className="w-[15%] font-semibold text-gray-700">Type</TableHead>
                            <TableHead className="w-[12%] font-semibold text-gray-700 text-center">Status</TableHead>
                            <TableHead className="w-[15%] font-semibold text-gray-700">Area</TableHead>
                            <TableHead className="w-[22%] font-semibold text-gray-700">Devices</TableHead>
                        </TableRow>
                    </TableHeader>
                    <TableBody>
                                    ...
                                    <TableCell className="text-center">
                                        <div className="flex items-center justify-center gap-1.5">
                                            <span className={`w-2 h-2 rounded-full flex-shrink-0 ${
                                                ...
                                                location.status === 'offline' ? 'bg-red-500' : 
                                                'bg-yellow-500'
                                            }`}></span>
                                            <span className={`text-xs font-semibold ${
                                                location.status === 'online' ? 'text-green-700' : 
                                                location.status === 'offline' ? 'text-red-700' : 
                                                'text-yellow-700'
                                            }`}>
