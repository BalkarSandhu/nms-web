...
export default function LocationDetailPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-1 border-black/100">
        <div className="lg:col-span-1 space-y-1 border-black/100">
          <Card>
            <CardHeader>
        ...
        <div className="lg:col-span-2 space-y-1">
            ...
            <CardContent>
              <div className="space-y-1 max-h-[300px] overflow-y-auto">
                {recentEvents.map((event, index) => (
                  <div key={index} className="flex gap-1 border-l-4 border-blue-500 pl-3 py-2">
          ...
          <Card>
            <CardHeader>
              <CardTitle>Location Availability Graph</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="h-[250px] flex items-center justify-center bg-gray-50 rounded border-2 border-dashed border-gray-300">
                <p className="text-gray-400">Graph placeholder - Add your chart here</p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader>
              <CardTitle>Devices at this Location Availability Graph</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="h-[250px] flex items-center justify-center bg-gray-50 rounded border-2 border-dashed border-gray-300">
                <p className="text-gray-400">Graph placeholder - Add your chart here</p>
