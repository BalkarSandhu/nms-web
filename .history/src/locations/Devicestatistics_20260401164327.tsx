...
// Metric card moved to a separate reusable component for cleaner structure.
import MetricBarCard from '@/device-info/MetricBarCard';

// Keep getMetricGaugeColor helper for possible device statistics adaptation.
