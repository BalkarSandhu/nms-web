          ...
          <Card className="border border-gray-200 shadow-sm hover:shadow-md transition">
            ...
            <CardContent className="p-2">
              <div className="space-y-0">
                <div className="space-y-1">
                  <div className="text-sm text-gray-600">System Name :{location.name}</div>
                ...
                <div className="space-y-1">
                  <div className="text-sm text-gray-600">Type : {locationType?.name}</div>
                  {/* <div className="text-sm font-medium text-gray-900">{locationType?.name || "Unknown"}</div> */}
                </div>

                <div className="border-t border-gray-200"></div>

                <div className="space-y-1">
                  <div className="text-sm text-gray-600">Area:{worker?.hostname || "N/A"}</div>
                  {/* <div className=" text-sm font-medium text-gray-900">{worker?.hostname || "N/A"}</div> */}
                </div>

                <div className="border-t border-gray-200"></div>

                <div className="space-y-1">
                  <div className="text-sm text-gray-600">Coordinates: {location.lat && location.lng ? `${location.lat.toFixed(4)}, ${location.lng.toFixed(4)}` : 'N/A'}</div>
                ...
                <div className="space-y-1">
                  ...
                  <div className="text-sm font-medium text-gray-900">{formatTimeAgo(location.created_at)}</div>
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <div className=" text-sm font-medium text-gray-900">{formatTimeAgo(location.updated_at)}</div>
                </div>
              </div>
            </CardContent>
          </Card>
