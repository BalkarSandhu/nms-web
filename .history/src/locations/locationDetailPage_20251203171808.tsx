    ...
    <div className="min-h-screen bg-white p-6">
      ...
      <div className="mb-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3 flex-1 ml-4">
          ...
          <div className={`ml-auto px-3 py-1 rounded-lg font-semibold text-xs flex items-center gap-2 whitespace-nowrap ${
            isLocationOnline 
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="space-y-4">
          ...
          <Card className="border border-gray-200 shadow-sm hover:shadow-md transition">
            <CardHeader className="bg-gradient-to-r from-blue-50 to-blue-50 border-b border-gray-200 p-0 py-3 px-4">
              <CardTitle className="flex items-center gap-3 text-lg font-semibold text-gray-900 m-0">
          ...
          {/* Devices Card */}
          <Card className="border border-gray-200 shadow-sm hover:shadow-md transition">
            <CardHeader className="bg-gradient-to-r from-purple-50 to-purple-50 border-b border-gray-200 p-0 py-3 px-4">
              <CardTitle className="flex items-center gap-3 text-lg font-semibold text-gray-900 m-0">
          ...
          {/* Logs Card */}
          <Card className="border border-gray-200 shadow-sm hover:shadow-md transition">
            <CardHeader className="bg-gradient-to-r from-amber-50 to-amber-50 border-b border-gray-200 p-0 py-3 px-4">
              <CardTitle className="flex items-center gap-3 text-lg font-semibold text-gray-900 m-0">
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <Card className="border border-gray-200 shadow-sm hover:shadow-md transition overflow-hidden h-96">
            <CardHeader className="bg-gradient-to-r from-cyan-50 to-cyan-50 border-b border-gray-200">
              <CardTitle className="flex items-center gap-3 text-lg font-semibold text-gray-900 m-0">
          ...
          <div className="grid grid-cols-2 gap-4">
            <Card className="border border-gray-200 shadow-sm hover:shadow-md transition overflow-hidden">
              <CardHeader className="bg-gradient-to-r from-green-50 to-green-50 border-b border-gray-200 p-0 py-3 px-4">
                <CardTitle className="text-sm font-semibold text-gray-900 m-0">Availability</CardTitle>
              </CardHeader>
            ...
            <Card className="border border-gray-200 shadow-sm hover:shadow-md transition">
              <CardHeader className="bg-gradient-to-r from-orange-50 to-orange-50 border-b border-gray-200 p-0 py-3 px-4">
                <CardTitle className="text-sm font-semibold text-gray-900 m-0">Network Health</CardTitle>
              </CardHeader>
          ...
          <div className="grid grid-cols-1 gap-4">
            ...
            <Card className="border border-gray-200 shadow-sm hover:shadow-md transition">
              <CardHeader className="bg-gradient-to-r from-blue-50 to-blue-50 border-b border-gray-200 p-0 py-3 px-4">
                <CardTitle className="text-lg font-semibold text-gray-900 m-0">Location Availability</CardTitle>
              </CardHeader>
            ...
            <Card className="border border-gray-200 shadow-sm hover:shadow-md transition">
              <CardHeader className="bg-gradient-to-r from-purple-50 to-purple-50 border-b border-gray-200 p-0 py-3 px-4">
                <CardTitle className="text-lg font-semibold text-gray-900 m-0">Devices Availability</CardTitle>
              </CardHeader>
