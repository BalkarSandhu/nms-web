...
// Reusable metric card moved to `src/device-info/MetricBarCard`.
        ...
        {uptimeLoading ? (
          ...
          <div className="space-y-3">
            ...
            <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-3">
              <MetricBarCard title="Packet Loss" value={uptimeData.avg_packet_loss_percent} unit="%" />
              <MetricBarCard title="Avg Jitter (ms)" value={uptimeData.avg_jitter_ms} unit="ms" />
              <MetricBarCard title="Avg Latency (ms)" value={uptimeData.avg_latency_ms} unit="ms" />
            </div>
