...
export default function LocationDetailPage() {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-1">
        ...
        <div className="space-y-2">
          ...
          <Card className="border border-gray-200 shadow-sm hover:shadow-md transition">
            <CardHeader className={cn("bg-gradient-to-r from-blue-50 to-blue-50 border-b border-gray-200 -mt-6 -mx-5 pt-4 px-6 pb-0")}>
  ...
  <div className="space-y-0">
    ...
    <div className="space-y-2">
      <div className="text-sm text-gray-600 flex justify-between">
        <span>Area:</span>
        <span className='font-medium'>{worker?.hostname || "N/A"}</span>
      </div>
    </div>
      ...
      <div className="text-sm text-gray-600 flex justify-between">
        ...
        <div className="lg:col-span-2 space-y-2">
          ...
          <div className="grid grid-cols-1 gap-2">
            ...
            <Card className="border border-gray-200 shadow-sm hover:shadow-md transition">
              <CardHeader className={cn("bg-gradient-to-r from-blue-50 to-blue-50 border-b border-gray-200 -mt-6 -mx-6 pt-4  pb-0")}>
