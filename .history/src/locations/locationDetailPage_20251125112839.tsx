...
export default function LocationDetailPage() {
  ...
  const worker = location?.worker_id 
    ? workers.find(w => w.id === (location as any).worker_id) 
    : undefined;
  ...
  // Mock recent events - replace with actual API call
  useEffect(() => {
    if (locationId) {
      // This should be replaced with actual event fetching logic
      const mockEvents = [
