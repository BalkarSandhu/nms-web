      ...
      <SidebarMenuItem>
        <DropdownMenu>
          ...
          >
            ...
            <DropdownMenuItem className="gap-2 p-2 hover:bg-(--azul) text-(--contrast) transition-colors duration-200">
              <div className="flex size-6 items-center justify-center rounded-md border border-(--azul) bg-transparent">
                <Plus className="size-4" />
              </div>
              <div className="font-medium text-(--contrast) opacity-80">Add team</div>
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
      </SidebarMenuItem>
