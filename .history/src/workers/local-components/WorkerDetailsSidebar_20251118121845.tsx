...
import { DeleteWorkerForm } from './DeleteWorkerForm';
                    ...
                    <DialogHeader className="flex flex-row items-center justify-between">
                        ...
                        <div className="flex gap-2">
                            <button
                                ...
                                className="flex items-center justify-center p-2 hover:bg-blue-50 rounded transition-colors"
                            ...
                            <button
                                ...
                                className="flex items-center justify-center p-2 hover:bg-red-50 rounded transition-colors"
