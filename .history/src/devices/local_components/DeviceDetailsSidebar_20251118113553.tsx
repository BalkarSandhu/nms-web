...
// Device Details Sidebar Component
    ...
    if (!deviceId) {
        return (
            <div className="md:flex md:flex-col hidden md:w-[280px] border-l-2 border-(--base)/20 p-4">
                <p className="text-gray-500 text-sm text-center mt-8">Select a device to view details</p>
            </div>
        );
    }
        ...
        <div className="md:flex md:flex-col hidden md:w-2/10 border-l-2 border-(--base)/20 bg-white overflow-y-scroll">
            ...
            <div className="p-4 border-b border-gray-200 sticky top-0 bg-white z-10">
                <div className="flex items-center justify-between">
                    <h2 className="text-lg font-bold text-gray-900 truncate">{device.display || device.hostname}</h2>
                    <button
                        onClick={onClose}
                ...
                <p className="text-xs text-gray-500 mt-1">Device Details</p>
            </div>
            ...
            <div className="border-b border-gray-100">
                ...
                {expandedSections.deviceInfo && (
                    <div className="px-4 pb-4 space-y-3">
                        ...
                        <InfoRow label="Port" value={device.port?.toString() || 'N/A'} />
                    ...
                    {expandedSections.location && (
                        <div className="px-4 pb-4">
                            <div className="bg-blue-50 rounded-lg p-3">
                                ...
                                {(location as any).lat && (location as any).lon && (
                                    <p className="text-xs text-blue-600 mt-2">
                                        {(location as any).lat.toFixed(4)}, {(location as any).lon.toFixed(4)}
                                    </p>
                                )}
                            </div>
                        </div>
