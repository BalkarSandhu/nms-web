                ...
                <div className="flex flex-col gap-1">
                    ...
                    {hasMedium && (
                        ...
                        >
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-2">
                                    <div className="w-2.5 h-2.5 rounded-full bg-(--azul) shadow-lg shadow-(--azul)/50"></div>
                                    <span className="text-(--contrast) font-semibold text-xs">{labels.medium}</span>
                                </div>
                                <div className="flex items-center gap-2">
                                    <span className="text-(--contrast) text-xl font-bold tracking-tight">{data.medium}</span>
                                    <span className="text-(--azul) text-xs font-bold min-w-[38px] text-right">{mediumPercent}%</span>
                                </div>
                            </div>
                        </button>
                    )}
