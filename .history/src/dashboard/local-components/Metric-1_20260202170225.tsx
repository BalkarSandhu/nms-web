...
export default function Metric1({ 
    ...
    const CircularProgress = ({ percent, color, size = 80 }: { percent: number; color: string; size?: number }) => {
            ...
            {viewMode === 'stats' ? (
                <div className="flex items-center gap-4 h-full py-2">
                        ...
                        {showGraph ? (
                            <div className="relative">
                                ...
                                <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 text-center">
                                    ...
                                    <div className="text-2xl font-bold text-(--contrast)">{total}</div>
                                </div>
                            </div>
                        ) : (
                            <>
                    ...
                    <div className="flex flex-col gap-1.5 flex-1">
                        {/* Trend Indicator */}
                        {showGraph && (
                            <div className="flex items-center justify-center gap-1 mb-1 pb-1 border-b border-gray-700/50">
                                {trend > 0 ? (
                ...
                <div className="flex flex-col items-center justify-center h-full py-1gap-3">
