...
return (
    <section className={`flex flex-col gap-1 w-full overflow-hidden transition-[height,min-height] duration-500 ease-in-out ${
        ...
        <div className="flex flex-row gap-2 items-center w-full py-2">
            ...
            <span className="text-white text-l font-bold tracking-wide uppercase bg-gradient-to-r from-blue-400 to-cyan-300 bg-clip-text text-transparent">{title}</span>
