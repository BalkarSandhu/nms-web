...
import type { Metric4Props } from "./Metric-4";
...
export type SectionMetricsData = {
    ...
    metric4?: Metric4Props; // Define proper type when Metric-4 is implemented
};
...
return (
    <section className={`flex flex-col gap-1 w-full overflow-hidden transition-[height,min-height] duration-500 ease-in-out ${
        ...
        <div className="flex flex-row gap-1 items-center w-full ">
            <div className="bg-gradient-to-r from-blue-500 to-cyan-400 w-1 h-4 rounded-full"/>
            <span className="text-white text-s font-bold tracking-wide uppercase bg-gradient-to-r from-blue-400 to-cyan-300 bg-clip-text text-transparent">{title}</span>
