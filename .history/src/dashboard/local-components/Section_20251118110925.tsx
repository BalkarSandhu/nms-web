...
return (
    <section className={`flex flex-col gap-2 w-full overflow-hidden transition-all duration-500 ease-in-out ${
    metricState 
        ? "h-[5000px] min-h-[5500px]"  // Increased from 550px
        : "h-[280px] min-h-[280px] max-h-[280px]"  // Increased from 210px
}`}>
