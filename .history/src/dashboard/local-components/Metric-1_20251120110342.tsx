                ...
                <div className="flex flex-col gap-1.5 flex-1">
                    ...
                    {labels.medium && data.medium > 0 && (
                        ...
                        >
                            <div className="flex items-center gap-1.5">
                                ...
                                <span className="text-(--contrast) text-xs font-medium">{labels.medium}</span>
                            </div>
                            <div className="flex items-center gap-1.5">
                                <span className="text-(--contrast) text-lg font-bold">{data.medium}</span>
                                <span className="text-(--azul) text-[10px] font-bold">{mediumPercent}%</span>
                            </div>
                        </button>
                    )}
                    ...
                    >
                        <div className="flex items-center gap-1.5">
                            ...
                            <span className="text-(--contrast) text-xs font-medium">{labels.high}</span>
                        </div>
                        <div className="flex items-center gap-1.5">
