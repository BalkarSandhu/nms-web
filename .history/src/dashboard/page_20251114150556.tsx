  ...
  .map(d => {
    ...
    return {
      ...
      popupData: {
        ...
        data: [
          { field: 'Location', value: location.name, colour: 'white' },
          { field: 'Last Ping', value: new Date(d.last_ping).toLocaleString(), colour: 'blue' },
          { field: 'Failures', value: d.consecutive_failures.toString(), colour: d.consecutive_failures > 0 ? 'red' : 'green' },
        ]
      }
    };
  })
